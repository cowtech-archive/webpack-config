export function babelRemoveFunction(options) {
        ...
        return {
            visitor: {
                ...
                ImportDeclaration(path) {
                    const hasDebugName = path.node.specifiers.findIndex((s) => { var _a; return ((_a = s.imported) === null || _a === void 0 ? void 0 : _a.name) === 'debugClassName'; });
                    if (hasDebugName >= 0) {
