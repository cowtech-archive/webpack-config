...
async function setupPlugins(options) {
    ...
    if (swOptions.enabled === true || options.environment === 'production') {
        ...
        if (swSrc) {
            ...
            const swDest = (_q = swOptions.dest, (_q !== null && _q !== void 0 ? _q : 'sw.js'));
            ...
            plugins.push(new ServiceWorkerEnvironment({
                ...
                debug: (_r = swOptions.debug, (_r !== null && _r !== void 0 ? _r : options.environment !== 'production'))
                ...
                ...(_s = swOptions.options, (_s !== null && _s !== void 0 ? _s : {}))
            }));
        }
    }
